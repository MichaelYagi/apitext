...
def get_data(url, debug_output, headerMap = {}, ttl_seconds = 20):
    ...
    if headers != None and headers.get("content-type") != None:
        ...
        if contentType.find("gif") != -1 or contentType.find("json") != -1 or contentType.find("text/plain") != -1 or contentType.find("image") != -1 or contentType.find("rss+xml") != -1 or contentType.find("atom+xml") != -1:
